...
#include <ardrone_autonomy/matrix33.h>
	...
	if(!initialized_navdata_publishers)
	{
		...
		{
			char navdata_demo_name[35];
			strcpy(navdata_demo_name, ardrone_control_config.ardrone_name);
			strcat(navdata_demo_name, "/navdata_demo");
			pub_navdata_demo = node_handle.advertise<ardrone_autonomy::navdata_demo>(navdata_demo_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_time_name[35];
			strcpy(navdata_time_name, ardrone_control_config.ardrone_name);
			strcat(navdata_time_name, "/navdata_time");
			pub_navdata_time = node_handle.advertise<ardrone_autonomy::navdata_time>(navdata_time_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_raw_measures_name[35];
			strcpy(navdata_raw_measures_name, ardrone_control_config.ardrone_name);
			strcat(navdata_raw_measures_name, "/navdata_raw_measures");
			pub_navdata_raw_measures = node_handle.advertise<ardrone_autonomy::navdata_raw_measures>(navdata_raw_measures_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_phys_measures_name[35];
			strcpy(navdata_phys_measures_name, ardrone_control_config.ardrone_name);
			strcat(navdata_phys_measures_name, "/navdata_phys_measures");
			pub_navdata_phys_measures = node_handle.advertise<ardrone_autonomy::navdata_phys_measures>(navdata_phys_measures_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_gyros_offsets_name[35];
			strcpy(navdata_gyros_offsets_name, ardrone_control_config.ardrone_name);
			strcat(navdata_gyros_offsets_name, "/navdata_gyros_offsets");
			pub_navdata_gyros_offsets = node_handle.advertise<ardrone_autonomy::navdata_gyros_offsets>(navdata_gyros_offsets_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_euler_angles_name[35];
			strcpy(navdata_euler_angles_name, ardrone_control_config.ardrone_name);
			strcat(navdata_euler_angles_name, "/navdata_euler_angles");
			pub_navdata_euler_angles = node_handle.advertise<ardrone_autonomy::navdata_euler_angles>(navdata_euler_angles_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_references_name[35];
			strcpy(navdata_references_name, ardrone_control_config.ardrone_name);
			strcat(navdata_references_name, "/navdata_references");
			pub_navdata_references = node_handle.advertise<ardrone_autonomy::navdata_references>(navdata_references_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_trims_name[35];
			strcpy(navdata_trims_name, ardrone_control_config.ardrone_name);
			strcat(navdata_trims_name, "/navdata_trims");
			pub_navdata_trims = node_handle.advertise<ardrone_autonomy::navdata_trims>(navdata_trims_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_rc_references_name[35];
			strcpy(navdata_rc_references_name, ardrone_control_config.ardrone_name);
			strcat(navdata_rc_references_name, "/navdata_rc_references");
			pub_navdata_rc_references = node_handle.advertise<ardrone_autonomy::navdata_rc_references>(navdata_rc_references_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_pwm_name[35];
			strcpy(navdata_pwm_name, ardrone_control_config.ardrone_name);
			strcat(navdata_pwm_name, "/navdata_pwm");
			pub_navdata_pwm = node_handle.advertise<ardrone_autonomy::navdata_pwm>(navdata_pwm_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_altitude_name[35];
			strcpy(navdata_altitude_name, ardrone_control_config.ardrone_name);
			strcat(navdata_altitude_name, "/navdata_altitude");
			pub_navdata_altitude = node_handle.advertise<ardrone_autonomy::navdata_altitude>(navdata_altitude_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_vision_raw_name[35];
			strcpy(navdata_vision_raw_name, ardrone_control_config.ardrone_name);
			strcat(navdata_vision_raw_name, "/navdata_vision_raw");
			pub_navdata_vision_raw = node_handle.advertise<ardrone_autonomy::navdata_vision_raw>(navdata_vision_raw_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_vision_of_name[35];
			strcpy(navdata_vision_of_name, ardrone_control_config.ardrone_name);
			strcat(navdata_vision_of_name, "/navdata_vision_of");
			pub_navdata_vision_of = node_handle.advertise<ardrone_autonomy::navdata_vision_of>(navdata_vision_of_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_vision_name[35];
			strcpy(navdata_vision_name, ardrone_control_config.ardrone_name);
			strcat(navdata_vision_name, "/navdata_vision");
			pub_navdata_vision = node_handle.advertise<ardrone_autonomy::navdata_vision>(navdata_vision_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_vision_perf_name[35];
			strcpy(navdata_vision_perf_name, ardrone_control_config.ardrone_name);
			strcat(navdata_vision_perf_name, "/navdata_vision_perf");
			pub_navdata_vision_perf = node_handle.advertise<ardrone_autonomy::navdata_vision_perf>(navdata_vision_perf_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_trackers_send_name[35];
			strcpy(navdata_trackers_send_name, ardrone_control_config.ardrone_name);
			strcat(navdata_trackers_send_name, "/navdata_trackers_send");
			pub_navdata_trackers_send = node_handle.advertise<ardrone_autonomy::navdata_trackers_send>(navdata_trackers_send_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_vision_detect_name[35];
			strcpy(navdata_vision_detect_name, ardrone_control_config.ardrone_name);
			strcat(navdata_vision_detect_name, "/navdata_vision_detect");
			pub_navdata_vision_detect = node_handle.advertise<ardrone_autonomy::navdata_vision_detect>(navdata_vision_detect_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_watchdog_name[35];
			strcpy(navdata_watchdog_name, ardrone_control_config.ardrone_name);
			strcat(navdata_watchdog_name, "/navdata_watchdog");
			pub_navdata_watchdog = node_handle.advertise<ardrone_autonomy::navdata_watchdog>(navdata_watchdog_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_adc_data_frame_name[35];
			strcpy(navdata_adc_data_frame_name, ardrone_control_config.ardrone_name);
			strcat(navdata_adc_data_frame_name, "/navdata_adc_data_frame");
			pub_navdata_adc_data_frame = node_handle.advertise<ardrone_autonomy::navdata_adc_data_frame>(navdata_adc_data_frame_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_video_stream_name[35];
			strcpy(navdata_video_stream_name, ardrone_control_config.ardrone_name);
			strcat(navdata_video_stream_name, "/navdata_video_stream");
			pub_navdata_video_stream = node_handle.advertise<ardrone_autonomy::navdata_video_stream>(navdata_video_stream_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_games_name[35];
			strcpy(navdata_games_name, ardrone_control_config.ardrone_name);
			strcat(navdata_games_name, "/navdata_games");
			pub_navdata_games = node_handle.advertise<ardrone_autonomy::navdata_games>(navdata_games_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_pressure_raw_name[35];
			strcpy(navdata_pressure_raw_name, ardrone_control_config.ardrone_name);
			strcat(navdata_pressure_raw_name, "/navdata_pressure_raw");
			pub_navdata_pressure_raw = node_handle.advertise<ardrone_autonomy::navdata_pressure_raw>(navdata_pressure_raw_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_magneto_name[35];
			strcpy(navdata_magneto_name, ardrone_control_config.ardrone_name);
			strcat(navdata_magneto_name, "/navdata_magneto");
			pub_navdata_magneto = node_handle.advertise<ardrone_autonomy::navdata_magneto>(navdata_magneto_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_wind_speed_name[35];
			strcpy(navdata_wind_speed_name, ardrone_control_config.ardrone_name);
			strcat(navdata_wind_speed_name, "/navdata_wind_speed");
			pub_navdata_wind_speed = node_handle.advertise<ardrone_autonomy::navdata_wind_speed>(navdata_wind_speed_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_kalman_pressure_name[35];
			strcpy(navdata_kalman_pressure_name, ardrone_control_config.ardrone_name);
			strcat(navdata_kalman_pressure_name, "/navdata_kalman_pressure");
			pub_navdata_kalman_pressure = node_handle.advertise<ardrone_autonomy::navdata_kalman_pressure>(navdata_kalman_pressure_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_hdvideo_stream_name[35];
			strcpy(navdata_hdvideo_stream_name, ardrone_control_config.ardrone_name);
			strcat(navdata_hdvideo_stream_name, "/navdata_hdvideo_stream");
			pub_navdata_hdvideo_stream = node_handle.advertise<ardrone_autonomy::navdata_hdvideo_stream>(navdata_hdvideo_stream_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_wifi_name[35];
			strcpy(navdata_wifi_name, ardrone_control_config.ardrone_name);
			strcat(navdata_wifi_name, "/navdata_wifi");
			pub_navdata_wifi = node_handle.advertise<ardrone_autonomy::navdata_wifi>(navdata_wifi_name, NAVDATA_QUEUE_SIZE);
		}
		...
		{
			char navdata_zimmu_3000_name[35];
			strcpy(navdata_zimmu_3000_name, ardrone_control_config.ardrone_name);
			strcat(navdata_zimmu_3000_name, "/navdata_zimmu_3000");
			pub_navdata_zimmu_3000 = node_handle.advertise<ardrone_autonomy::navdata_zimmu_3000>(navdata_zimmu_3000_name, NAVDATA_QUEUE_SIZE);
		}
